  ...
  <div>
    ...
    <form action="/" className={style.form}>
      ...
      <div className="send_input">
        ...
        <input type="text" onChange={(e)=>{setnumber(e.target.value)}} className={style.input}/>
      </div>
      <div className="send_input">
        <label className={style.label}>学部学科</label>
        <input type="text" onChange={(e)=>{setmajor(e.target.value)}} className={style.input}/>
      </div>
      <div className="send_input">
        <label className={style.label}>学年</label>
        <input type="text" onChange={(e)=>{setGrade(e.target.value)}} className={style.input}/>
      </div>
    </form>
    <Button onClick={handleUserInfo} className={style.button}>完了</Button>
  </div>
  )
}
