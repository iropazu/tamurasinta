...
const Login = () => {
  ...
  return (
    <div className={style.main}>
      <h1 className={style.body}>ログイン</h1>

      <div>
        <p className={style.p}>メールアドレス</p>
        <input
          onChange={(e) => {
      ...
      <div>
        <p className={style.mataha}>または</p>
      </div>
      ...
      <button onClick={handleLogin} className={style.button01}>
        ログイン
      </button>
    </div>
  )
